            ...
            <div class="page-header">
                ...
                <div>
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Wanachama</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    {{--  <div class="card-header" style="background-color: #eee;">
                        <h3 class="well">Orodha ya Wanachama</h3>
                    </div>  --}}
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        {{--  <div class="card-header">
                            <h3 class="card-title">Orodha ya Wanachama</h3>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="member" class="table table-striped table-bordered text-nowrap w-100">
                                    <thead>
                                        <tr>
                                            <th class="wd-15p">#</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="{{ url('/members/view', $member['memberId']) }}" >
                                            ...
                                            @if(in_array('view-mwanachama' ,permissions()))
                                                ...
                                                <button type="button" class="btn btn-icon  btn-danger">
                                                    <a href="{{ url('/members/edit', $member['memberId']) }}" style="color:white;"><i class="fe fe-delete"></i>
                                                </button>  --}}
