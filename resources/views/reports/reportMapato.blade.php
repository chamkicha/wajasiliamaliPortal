    ...
    <div class="app-content">
        <div class="side-app">
            <div class="page-header">
                ...
                <div>
                    <h1 class="page-title">Ripoti za Mapato</h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}">Nyumbani</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    {{--  <div class="card-header" style="background-color: #eee;">
                        <h3 class="well">Orodha ya Mwanachama</h3>
                    </div>  --}}
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="text-black">
                                            <h2 class="mb-0 number-font">100,000</h2>
                                            <p class="text-black mb-0">JUMLA YA MAPATO </p>
                                        </div>
                                        <div class="ml-auto"> <i class="fa fa-bank text-black fs-30 mr-2 mt-2"></i> </div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- COL END -->
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="text-black">
                                            ...
                                            <p class="text-black mb-0">MADENI</p>
                                        </div>
                                        <div class="ml-auto"> <i class="fa fa-money text-black fs-30 mr-2 mt-2"></i> </div>
                                    </div>
                                </div>
                            </div>
                        </div><!-- COL END -->
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="card img-card box-success-shadow">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="text-black">
                                            <h2 class="mb-0 number-font">80,000</h2>
                                            <p class="text-black mb-0">MAKUSANYO</p>
                                        </div>
                                        <div class="ml-auto"> <i class="fa fa-money text-black fs-30 mr-2 mt-2"></i> </div>
                                    </div>
                                </div>
                    ...
                    <br>
                    @include('reports.mapatosearch_form')
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="card">
                        {{--  <div class="card-header">
                            <h3 class="card-title">Orodha ya Mwanachama</h3>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Wailisha</button>
                </div>
            </form>
        </div>
        </div>
